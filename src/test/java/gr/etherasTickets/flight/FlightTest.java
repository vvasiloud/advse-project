...
public class FlightTest {
	...
	@Test
	public void testGetFlightById2() throws BadArguments, NotFound{
		
		// Flight expectedFlight=repository.findAll().get(0);
		 String  flightID = repository.findAll().get(0).getId();
		 Flight actualFlight = repository.getFlightById(flightID);
		  
		 String stringExpectedFlight=("Athens Thessaloniki");
		 String stringActualFlight=(actualFlight.getFrom()+" "+actualFlight.getTo());
		 assertEquals(stringExpectedFlight, stringActualFlight);
